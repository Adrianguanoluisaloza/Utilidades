...
public class RecomendacionRepository {
    ...
    private static List<Map<String, Object>> cachedDestacadas = null;
    ...
    public List<Map<String, Object>> listarDestacadas() throws SQLException {
        ...
        if (cachedDestacadas != null && (now - cacheTime) < CACHE_DURATION) {
            return new ArrayList<>(cachedDestacadas);
        }
        String sql = """
            SELECT
                p.id_producto,
