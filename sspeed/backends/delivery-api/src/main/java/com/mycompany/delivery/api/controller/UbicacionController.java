...
public class UbicacionController {
    ...
    // ===============================
    public void actualizarCoordenadas(long idUsuario, Double latitud, Double longitud) {
    ...
    public ApiResponse<Void> eliminarUbicacion(int idUbicacion) {
        ...
        try {
            ...
            return ApiResponse.success(204, "Ubicación eliminada correctamente", null);
        } catch (SQLException e) {
            throw new ApiException(500, "Error al eliminar la ubicación", e);
        }
    }

    public ApiResponse<Map<String, Object>> obtenerUbicacionTracking(long idPedido) {
        try {
    ...
    public ApiResponse<List<Map<String, Object>>> obtenerRutaTracking(long idPedido) {
        try {
