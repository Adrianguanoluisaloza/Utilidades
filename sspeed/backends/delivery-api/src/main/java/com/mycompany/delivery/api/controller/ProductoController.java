...
public class ProductoController {
    ...
    public ApiResponse<Void> deleteProducto(int idProducto) {
        ...
        try {
            ...
            return ApiResponse.success(204, "Producto eliminado correctamente", null);
        } catch (SQLException e) {
    ...
    /**
     * Obtiene categorías directamente desde la tabla 'categorias' (incluye las
     * que aún no tienen productos).
     */
    public ApiResponse<List<java.util.Map<String, Object>>> obtenerCategoriasDb() {
        try {
            var lista = repo.listarCategoriasDb();
            return ApiResponse.success(200, "Categorías (tabla) obtenidas", lista);
        } catch (SQLException e) {
            throw new ApiException(500, "No se pudieron obtener las categorías desde la tabla", e);
        }
    }
}
