...
public class UbicacionService {
    ...
    // ===============================
    public void actualizarUbicacionRepartidor(long idRepartidor, UbicacionUpdateRequest ubicacionRequest) {
        if (idRepartidor <= 0) {
    ...
    public java.util.Optional<Map<String, Double>> obtenerUbicacionTracking(long idPedido) throws SQLException {
