    ...
    public static void main(String[] args) {
        ...
        app.before(ctx -> {
            ...
            if (auth != null && auth.toLowerCase(Locale.ROOT).startsWith("bearer ")) {
                ...
                try {
                    var user = USUARIO_CONTROLLER.validarToken(token);
    ...
    private static void registerRoutes(Javalin app) {
        ...
        app.post("/auth/reset/confirmar", ctx -> {
            ...
            try {
                ...
                if (!ok) throw new ApiException(500, "No se pudo actualizar la contraseña");
        ...
        app.post("/productos/{id}/recomendaciones", ctx -> {
            ...
            if (puntuacion == null) throw new ApiException(400, "puntuacion es obligatoria");
        ...
        app.post("/recomendaciones/productos", ctx -> {
            ...
            String preferencias = (String) body.get("preferencias");
