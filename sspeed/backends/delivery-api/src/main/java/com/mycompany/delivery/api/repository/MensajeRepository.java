...
public class MensajeRepository {
    ...
    public boolean insertarMensaje(Mensaje mensaje) throws SQLException {
        ...
        try (Connection conn = Database.getConnection();
            ...
            stmt.setLong(1, mensaje.getIdPedido());
    ...
    // ===========================
    public List<Mensaje> obtenerMensajesPorPedido(long idPedido) throws SQLException {
    ...
    private Mensaje mapRowToMensaje(ResultSet rs) throws SQLException {
        ...
        m.setIdMensaje(rs.getLong("id_mensaje"));
        m.setIdPedido(rs.getLong("id_pedido"));
