...
public class Payloads {
    ...
    // =========================== PASSWORD RESET ===========================
    public static class ResetGenerateRequest {
        public String correo; // correo del usuario para generar código
    }

    public static class ResetConfirmRequest {
        public String correo;
        public String codigo; // 6 dígitos
        @SerializedName(value = "nuevaContrasena", alternate = {"nueva_contrasena", "newPassword"})
        public String nuevaContrasena;
    }

    public static class ChangePasswordRequest {
        @SerializedName(value = "actual", alternate = {"current", "oldPassword"})
        public String actual;
        @SerializedName(value = "nueva", alternate = {"new", "newPassword"})
        public String nueva;
    }
    ...
    public static class PedidoDetallePayload {
        ...
        @SerializedName(value = "precio_unitario", alternate = {"precioUnitario"})
