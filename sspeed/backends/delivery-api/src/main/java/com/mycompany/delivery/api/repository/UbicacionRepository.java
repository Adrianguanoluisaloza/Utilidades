...
public class UbicacionRepository {
    ...
    public Optional<Ubicacion> guardar(Ubicacion ubicacion) throws SQLException {
        ...
        try (Connection conn = Database.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            stmt.setLong(1, ubicacion.getIdUsuario());
    ...
    // ===============================
    public boolean actualizarUbicacionLive(long idUsuario, double latitud, double longitud) throws SQLException {
        String sql = """
    ...
    public void insertarUbicacionLive(long idUsuario, double latitud, double longitud) throws SQLException {
        String sql = """
    ...
    public void registrarEventoTracking(long idDelivery, double latitud, double longitud) throws SQLException {
        String sql = """
        ...
        try (Connection conn = Database.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
            stmt.setDouble(1, latitud);
            stmt.setDouble(2, longitud);
            stmt.setLong(3, idDelivery);
            stmt.executeUpdate();
        }
    }

    public Optional<Map<String, Double>> obtenerUbicacionTracking(long idPedido) throws SQLException {
        String sql = """
    ...
    public List<TrackingEvento> obtenerRutaPedido(long idPedido) throws SQLException {
    ...
    // ===============================
    public List<Ubicacion> obtenerPorUsuario(long idUsuario) throws SQLException {
    ...
    // ELIMINAR UBICACIÓN
    // ===============================
    public boolean eliminar(long idUbicacion) throws SQLException {
        String sql = "DELETE FROM ubicaciones WHERE id_ubicacion = ?";
        try (Connection conn = Database.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
            stmt.setLong(1, idUbicacion);
    ...
    private Ubicacion mapRow(ResultSet rs) throws SQLException {
        ...
        u.setIdUbicacion(rs.getLong("id_ubicacion"));
    ...
    public List<Map<String, Object>> obtenerUbicacionesDeRepartidores(List<Integer> repartidorIds) throws SQLException {
        ...
        try (Connection conn = Database.getConnection(); PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    ubicaciones.add(Map.of("id_repartidor", rs.getLong("id_usuario"), "latitud", rs.getDouble("latitud"),
