...
class DatabaseService implements DataSource {
  ...
  @override
  Future<Map<String, dynamic>> generarReset(String correo) =>
      _dataSource.generarReset(correo);

  @override
  Future<bool> confirmarReset(
          String correo, String codigo, String nuevaContrasena) =>
      _dataSource.confirmarReset(correo, codigo, nuevaContrasena);

  @override
  Future<bool> cambiarPassword(
          {required String actual, required String nueva}) =>
      _dataSource.cambiarPassword(actual: actual, nueva: nueva);
  ...
  @override
  Future<List<Ubicacion>> getUbicacionesActivas() =>
      _dataSource.getUbicacionesActivas();
  ...
  // --- Opiniones ---
  @override
  Future<List<Map<String, dynamic>>> getOpiniones({int limit = 20}) =>
      _dataSource.getOpiniones(limit: limit);
  ...
  Future<List<Map<String, dynamic>>> getOpinionesAdmin(
          {String? clasificacion, int limit = 50}) =>
      _dataSource.getOpinionesAdmin(clasificacion: clasificacion, limit: limit);
}
