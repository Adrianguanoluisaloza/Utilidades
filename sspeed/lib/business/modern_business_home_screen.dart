...
class ModernBusinessHomeScreen extends StatefulWidget {
  ...
  @override
  State<ModernBusinessHomeScreen> createState() =>
      _ModernBusinessHomeScreenState();
}
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ProductNameOptimizer.optimizarNombre(nombreComercial),
                    ...
                    Text(
                      'Dueño: ${ProductNameOptimizer.optimizarNombre(nombreDueno)}',
                      style: TextStyle(
        ...
        children: [
          ModernActionCard(
            ...
            onTap: () => Navigator.of(context).push(
              MaterialPageRoute(
                builder: (_) =>
                    BusinessProductsView(negocioUser: widget.businessUser),
              ),
            ),
          ),
          ModernActionCard(
