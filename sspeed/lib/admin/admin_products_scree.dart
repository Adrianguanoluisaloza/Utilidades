...
class _AdminProductsScreenState extends State<AdminProductsScreen> {
  ...
  void _loadProducts() {
    _productosFuture = Provider.of<DatabaseService>(context, listen: false)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => _navigateAndRefresh(
            const AdminEditProductScreen()), // Navega a la pantalla de creación
  ...
  Widget _buildAvailabilityChip(bool available) {
    return Chip(
      avatar: Icon(
          ...
          color: Colors.white,
          size: 16),
      label: Text(available ? 'Disponible' : 'No Disponible',
          style: const TextStyle(
