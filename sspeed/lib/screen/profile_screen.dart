      ...
      body: AdaptiveScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Card(
              ...
              child: Column(
                children: [
                  ...
                  // MEJORA: Bot�n para convertirse en negocio (solo para clientes)
                  if (widget.usuario.rol != 'negocio' &&
                    ...
                    _buildMenuOption(
                      context,
                      icon: Icons.store,
                      color: Color(0xFFF97316), // Naranja del tema
                      title: 'Convertirse en Negocio',
                      subtitle: 'Registra tu negocio y vende productos',
                      onTap: () => Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => RegisterBusinessScreen(usuario: widget.usuario),
                        ),
                      ),
                    ),
                  ],
            ...
            // MEJORA: Se a�ade un men� exclusivo para administradores.
