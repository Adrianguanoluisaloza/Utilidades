...
import 'tracking_simulation_screen.dart';
...
class _OrderTrackingScreenState extends State<OrderTrackingScreen> {
  ...
  // Widget de Mapa con botón para abrir simulación completa
  Widget _buildMapPlaceholder(BuildContext context) {
    return GestureDetector(
      onTap: () {
        // Navegar a la simulación completa
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (_) => TrackingSimulationScreen(idPedido: widget.orderId),
          ),
        );
      },
      child: Container(
        ...
        child: Stack(
          ...
          children: [
            ...
            Opacity(
              opacity: 0.3,
              child: Icon(Icons.map, size: 200, color: Colors.blue.shade700),
            ),
            // Contenido central
            Column(
                ...
                Container(
                  ...
                  child: Column(
                    children: const [
                      ...
                      SizedBox(height: 4),
                      Text(
                        'Toca para abrir el mapa completo',
            ...
            const Positioned(
              top: 30,
              left: 30,
              child: Icon(Icons.store, size: 32, color: Colors.orange),
            ),
            const Positioned(
              top: 100,
              right: 80,
              child: Icon(Icons.delivery_dining, size: 36, color: Colors.blue),
            ),
            const Positioned(
              bottom: 30,
              right: 30,
              child: Icon(Icons.home, size: 32, color: Colors.green),
            ),
          ],
        ),
      ),
