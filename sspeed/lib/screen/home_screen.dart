...
String _resolveImageUrl(String? url) {
  ...
  const s3BaseUrl =
      'http://unitespeed-landing-2025.s3-website.us-east-2.amazonaws.com/productos/';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  */
  ...
  Widget _buildLiveTrackingCard() {
    ...
    // TODO: Implementar notificaciones push cuando el pedido esté cerca
    // Para activar notificaciones Gmail API, descomentar la siguiente sección:
