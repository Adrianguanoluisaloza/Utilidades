...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  void initState() {
    ...
    if (widget.openReviews) {
      // Desplazar a la secci�n de rese�as al cargar
          ...
          children: [
            Row(
              ...
              children: [
                ...
                const SizedBox(width: 8),
                Text('(${resumen.totalResenas} resenas)',
            ...
            if (lista.isEmpty)
              ...
              ListView.separated(
                ...
                itemBuilder: (context, index) =>
                    _ReviewTile(review: lista[index]),
              ),
          ],
        );
      },
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: widget.usuario.rol == 'delivery'
          ? null // Repartidores no pueden agregar al carrito
          : Padding(
              ...
              child: AppButton(
                ...
                onPressed: () {
                  ...
                  if (mounted) {
                    ...
                    SnackBar(
                      content: Text(
                          '${widget.producto.nombre} fue a�adido al carrito.'),
