...
class CartScreen extends StatelessWidget {
  ...
  Widget _buildEmptyCartView(BuildContext context) {
    return EmptyState(
      ...
      message:
          'Parece que todavía no has añadido ningún producto. ¡Empieza a explorar! ',
  ...
  Widget _buildCartListView(CartModel cart) {
    return AdaptiveListViewBuilder(
  ...
  Widget _buildSummaryAndCheckout(
      BuildContext context, CartModel cart, Usuario usuario) {
          ...
          AppButton(
            ...
            onPressed: () {
              Navigator.of(context)
                  .pushNamed(AppRoutes.checkoutAddress, arguments: usuario);
            },
          )
        ],
      ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('\$${cartItem.producto.precio.toStringAsFixed(2)}',
                        style: const TextStyle(
                            fontSize: 15,
